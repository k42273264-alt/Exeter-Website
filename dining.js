document.addEventListener('DOMContentLoaded', () => {
    ...
    const initVenueModal = () => {
      ...
      const venueDetails = {
        'Drakes Restaurant & Bar': {
          details: 'Drakes Restaurant & Bar offers fine dining with modern British menus featuring locally sourced ingredients. Accommodating up to 100 guests in the heart of Exeter, it provides a sophisticated ambiance ideal for special occasions.'
        }
      };
